...
export default function TongjiBadgePage() {
    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      <header className="py-6 px-8">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <h1 className="text-xl font-bold">同济大学东方例会贡献勋章</h1>
        </div>
      </header>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="absolute w-full h-full rounded-full" style={{
              background: 'linear-gradient(to right, #886c24, #e2c053, #fdf6c8, #e2c053, #886c24)',
            ...
            {/* 徽章背面 */}
            <div className="absolute w-full h-full rounded-full" style={{
              background: 'linear-gradient(135deg, #886c24 0%, #e2c053 100%)',
            ...
            {/* 外部金属环 */}
            <div className="absolute w-full h-full rounded-full" style={{
              background: 'linear-gradient(135deg, #e2c053 0%, #fdf6c8 25%, #e2c053 50%, #fdf6c8 75%, #e2c053 100%)',
            ...
            <div className="absolute w-[96%] h-[96%] rounded-full" style={{
              background: 'linear-gradient(135deg, #113175 0%, #1a4b9c 100%)',
            ...
            >
              ...
              <div className="w-[85%] h-[85%] flex items-center justify-center overflow-hidden rounded-full">
                <img 
                  ...
                  style={{
                    filter: 'drop-shadow(0 0 5px rgba(226, 192, 83, 0.5))'
                  }}
                />
              </div>
            </div>
        ...
        <div className="mt-16 text-center max-w-md">
          <h2 className="text-2xl font-bold mb-3 text-yellow-400" style={{
            textShadow: '0 0 10px rgba(226, 192, 83, 0.3)'
          }}>东方例会贡献勋章</h2>
          <p className="text-gray-400 mb-6">
            此勋章授予积极参与同济大学东方例会活动的社团成员，
            表彰其在弹幕文化传播与社团活动组织中的杰出贡献。
          </p>
          <div className="flex justify-center gap-3 text-xs text-gray-500">
            ...
            <div className="flex items-center">
              <span className="w-3 h-3 inline-block rounded-full bg-yellow-400 mr-1"></span>
              金色 - 卓越贡献
            </div>
          </div>
        </div>
